...
build_kernel() {
	...
	if [ "$PTTG" = 1 ]
 	then
		tg_post_msg "<b>$KBUILD_BUILD_VERSION CI Build Triggered</b>

<b>Docker OS: </b><code>$DISTRO</code>

<b>Kernel Version : </b><code>$KERVER</code>

<b>Date : </b><code>$(TZ=Asia/Kolkata date)</code>
...
<b>Branch : </b><code>$CI_BRANCH</code>

<b>Top Commit : </b><code>$COMMIT_HEAD</code>

<b>Etherious Build Progress: </b><a href='$SERVER_URL'> Check Here </a>"
	fi
